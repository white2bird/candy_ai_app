<template>
    <div class="form">
        ...
        <div style="display: flex;">
            ...
            <el-input v-model="username" placeholder="请设置用户名,2-20个字符" clearable @blur="checkusername()" />
        </div>
        <div style="height: 25px;">
            <p v-show="usernametip">*用户名不符合输入规范*允许2-20个字符</p>
        </div>
        ...
        <div style="display: flex;">
            ...
            <el-input v-model="password" placeholder="请设置密码,5-20个字符" show-password @blur="checkpassword()" />
        </div>

        <div style="height: 25px;">
            <p v-show="passwordtip">*密码不符合输入规范*允许5-20个字符</p>
        </div>
...
const emiter = defineEmits(['registerSuccess'])
...
function checkusername() {
    ...
    const isLongEnough = username.value.length >= 2;
...
function checkpassword() {
    ...
    const isLongEnough = password.value.length >= 5;
